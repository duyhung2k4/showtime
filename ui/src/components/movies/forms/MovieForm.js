    ...
    <Card className={classes}>
      <Form onSubmit={submitHandler}>
        ...
        <Form.Group className="mb-3" controlId="productionCountry">
          <Form.Label>Quốc gia sản xuất</Form.Label>
          <Form.Control
            type="text"
        ...
        <Form.Group className="mb-3" controlId="trailer">
          ...
          <Form.Control
            type="text"
            placeholder="Nhập YouTube Video Key..."
        ...
        <Form.Group className="mb-3" controlId="genres">
          ...
          <div className={styles.inputButtonGroup}>
            <Form.Control
              ...
              value={genreInput}
            />
            <Button onClick={addGenreHandler}>Thêm</Button>
          </div>
        ...
        <Form.Group className="mb-3" controlId="keywords">
          ...
          <div className={styles.inputButtonGroup}>
            <Form.Control
              ...
              value={keywordInput}
            />
            <Button onClick={addKeywordHandler}>Thêm</Button>
          </div>
          <motion.div className={styles.badgeContainer}>
        ...
        <Form.Group className="mb-3" controlId="screenwriter">
          <Form.Label>Kịch bản</Form.Label>
          <Form.Control
            type="text"
        ...
        <Form.Group className="mb-3" controlId="cast">
          ...
          <div className={styles.inputButtonGroup}>
            ...
            />
            <Button onClick={addCastHandler}>Thêm</Button>
          </div>
