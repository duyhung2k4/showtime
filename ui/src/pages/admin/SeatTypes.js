...
const SeatTypes = (props) => {
  ...
  const submitHandler = async (type) => {
    try {
      if (isNew) {
        ...
        createMessage({
          text: "Đã tạo loại ghế thành công",
          variant: "success",
        });
      } else {
        ...
        setShowSeatTypeModal(false);
        createMessage({
          text: "Đã cập nhật loại ghế thành công",
          variant: "success",
        });
      }
    } catch (err) {
  ...
  const deleteHandler = async () => {
    try {
      ...
      createMessage({
        text: "Đã xóa loại ghế thành công",
        variant: "success",
      });
      setTypes((prevTypes) => [
  ...
  return (
    <>
      ...
      <DeleteModal
        ...
        text="Bạn có chắc chắn muốn xóa loại ghế này không?"
